...
import pretrainedmodels  # 预训练模型库(pytorch)
...
labels_path = "../input/labels.csv" # 标签数据
sample_path = "../input/sample_submission.csv" # 样本信息数据
stanford_lables_path = "../input/stanford_lables.csv" # 斯坦福数据
...
def main(resume=False):
    ...
    labelnames = sample_df.keys()[1:]  # 去掉第一列的id列 品种名称
